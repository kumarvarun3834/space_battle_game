...
jet=pygame.mixer.Sound("Assets/good-jetpack-sound-loop-96693.mp3")
title="Assets/the_field_of_dreams.mp3"
SPACE_SHIP_WIDTH,SPACE_SHIP_HEIGHT=60,60
RED_SHIP_image=pygame.image.load("Assets/white_ship.png")
RED_SHIP=pygame.transform.rotate(pygame.transform.scale(RED_SHIP_image,(SPACE_SHIP_WIDTH,SPACE_SHIP_HEIGHT)),90)
YELLOW_SHIP_image=pygame.image.load("Assets/blue_ship.png")
...
logo=pygame.transform.scale(pygame.image.load("Assets/BattleSpaceHomeScreen.png"),(WIDTH,HEIGHT))
